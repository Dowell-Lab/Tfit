...
/** Rearranges a set of segments to better fit the current processing environment (ie. number of cores/workers).
 * @param segments Set of unoptimized input segments.
 * @param rank Rank parameter obtained from the MPI runtime.
 * @param nprocs Processor count obtained from the MPI runtime.
 * @return Optimized set of segments.
 */
...
/** Encapsulates a set of lower and upper boundaries.
 */
struct bounds{
public:
...
/** Sorts and organizes a set of predictions utilizing a depreciated params object.
 * @depreciated
 * @param all Set of all calls generated by the model.
 * @param segments Set of input segments read from a bedgraph.
 * @param rank Rank parameter obtained from the MPI runtime.
 * @param nprocs Number of processors obtained from the MPI runtime.
 * @param out_file_dir Path to the output directory.
 * @param job_name Name of the currently running job.
 * @param job_ID Identifier for the currently running job. This is most likely obtained from the MPI runtime.
 * @param P Obsolete params object with which a summary of command line arguments can be generated.
 * @param noise Unused.
...
/** Sorts and organizes a set of predictions utilizing a ParamWrapper.
 * @param all Set of all calls generated by the model.
 * @param segments Set of input segments read from a bedgraph.
 * @param rank Rank parameter obtained from the MPI runtime.
 * @param nprocs Number of processors obtained from the MPI runtime.
 ...
 * @param job_name Name of the currently running job.
 * @param job_ID Identifier for the currently running job. This is most likely obtained from the MPI runtime.
 * @param pw ParamWrapper object with which a summary of command line arguments can be generated.
 * @param noise Unused.
 * @return The total number of calls made.
 */
...
/** Simplified representation of a given segment in which only chromosome, strand, and start/stop points are stored.
 */
...
/** Distributes segments across MPI workers.
 * @param FSI segments to distribute to all workers.
 * @param rank rank parameter obtained from the MPI runtime.
 * @param nprocs number of workers obtained from the MPI runtime.
 * @return Assigned set of segments, mapped by their chromosome.
 */
...
/** Distributes model parameters among all MPI workers and then returns the set of synchronized parameters.
 * @param parameters Set of model parameters to broadcast.
 * @param rank rank parameter obtained from the MPI runtime.
 * @param nprocs number of workers obtained from the MPI runtime.
 * @return Synchronized parameters.
 */
...
/** Obtains the current running job ID specified as a parameter to a number of other functions.
 * @param path Temporary scratch directory path.
 * @param job_ID Job ID string obtained from command line arguments and the MPI runtime.
 * @param rank Rank parameter obtained from the MPI runtime.
 * @param nprocs Number of workers obtained from the MPI runtime.
 * @return Job ID
 */
...
/** Distributes simple_c_free_mode objects among worker processes.
 * @param FITS set of simple_c_free_mode objects to distribute
 * @param rank rank parameter obtained from the MPI runtime.
...
/** Waits for the initial (user invoked) process to respond.
 * @param rank Rank parameter obtained from the MPI runtime.
 * @param nprocs Number of workers obtained from the MPI runtime.
 */
...
/** Converts a flat set of segmens into a map of strings (chromosome names) to segment vectors.
 * @param FSI set of input segments.
 * @return Map of input segments indexed to their chromosome.
 */
