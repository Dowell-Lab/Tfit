...
/** Default constructor. This sets all values to their defaults; this proved
 * to be the basis upon which ParamWrapper was constructed. Please note that
 * the last published Tfit documentation directly from this project's original developer
 * features a different set of default parameters than is represented here.
 */
params::params(){
  p["-N"] 		= "EMG";
  p["-v"] 		= "1";
...
/** Returns whether or not a given string is an acceptable decimal number.
 * @param s The string to check
 * @return Whether or not the string contains a decimal number.
 */
...
/** Returns whether or not a given string contains an int.
 * @param s The string to check
 * @return whether or not the string contains an integer.
 */ 
...
/** Returns whether or not the given string contains a sequence of digits.
 * @param input The string to check
 * @return Whether or not the given string contains a sequence of digits
 */
bool isNumeric(const std::string& input) {
	return std::all_of(input.begin(), input.end(), ::isdigit);
}

/** Determines whether or not the given string contains a number.
 * @param s The string to check
 * @return Whether the string contains a number.
 */
...
/** Determines whether or not the given string contains a valid path.
 * @param s The string to check
 * @return Whether the string contains a number.
 */
...
/** Determines whether or not the user passed appropriate values for all given parameters.
 * For example, if a value that's normally specified as in integer or path is not specified as such, then
 * this function will return an error string matching that problem.
 * 
 * @return A vector of error messages for all non-compliant parameters.
 */
 ...
 * This function was duplicated within the ParamWrapper codebase so that the old style
 * parameter handling codebase could eventually be removed.
 * @return The current date and time represented as a string.
 */
...
/** Displays a number of relevant parameters.
 * This function was reimplemented in the ParamWrapper module in order to meet general feature parity.
 * 
 * @param nodes Number of nodes obtained through the MPI runtime.
 * @param cores Number of cores obtained through the MPI runtime.
 */
...
/** Returns a string containing various pretty printed command line options.
 * This function was reimplemented within ParamWrapper in order to have feature parity.
 * 
 * @param ID Running task ID number obtained from the MPI runtime.
 * @return A pretty printed list of parameters.
 */
...
/** Splits a line down into individual parameters and values.
 * This function is used to parse the outputs generated by the get_header() function in the params class, 
 * as it can extract a parameter representation from each line in a given pretty printed header.
 * 
 * @param line Input line to parse.
 * @param param String in which to store the parameter (command line option)
 * @param value String in which to store the value to which the parameter is to be set.
 */
...
/** Writes a set of parameters to a configuration file.
 * Functionality similar to this in addition to other configuration handling should be integrated into the ParamWrapper class at some point.
 * 
 * @param FILE Path to the file in which to store the configuration. This file will be created if it does not exist.
 * @param P Pointer to the params object to write.
 * @param rank Rank parameter obtained through the MPI runtime.
 */
...
/** Parses command line arguments and fills a params object.
 * This is equivalent to the second constructor in the ParamWrapper class.
 * 
 * @param argv The argument string array passed to main()
 * @param P Pointer to the params object to fill.
 * @param rank Rank parameter obtained through the MPI runtime.
 */
...
/** Parses command line arguments and places them into a params object.
 * This differs from fill_in_options in that it first checks for a module name to run.
 * 
 * @param argv Argument array passed to main()
 * @param P params object in which to place data.
 * @param rank Rank parameter obtained through the MPI runtime.
 */
